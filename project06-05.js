...
window.addEventListener("load", function() {
   ...
   document.getElementById("fnBox").addEventListener("onfocusout", calcCart);
   document.getElementById("lnBox").addEventListener("onfocusout", calcCart);
   document.getElementById("groupBox").addEventListener("onfocusout", calcCart);
   document.getElementById("mailBox").addEventListener("onfocusout", calcCart);
   document.getElementById("phoneBox").addEventListener("onfocusout", calcCart);
   document.getElementById("sessionBox").addEventListener("onfocusout", calcCart);
   document.getElementById("banquetBox").addEventListener("onfocusout", calcCart);
   document.getElementById("mediaCB").addEventListener("onfocusout", calcCart);
});
...
function calcCart() {
   ...
   if (selectedSession !== -1) {
      sessionChoice = document.forms.register.elements.sessionBox[selectedSession].selectedIndex;
      sessionCost = document.forms.register.elements.sessionBox[selectedSession].selectedIndex;
   }
