...
window.addEventListener("load", function() {
   ...
   document.getElementById("sessionBox").addEventListener("blur", calcCart);
   document.getElementById("banquetBox").addEventListener("blur", calcCart);
   document.getElementById("mediaCB").addEventListener("blur", calcCart);
});
...
function calcCart() {
   ...
   if (selectedSession !== -1) {
      let sessionChoice = document.getElementById("sessionBox").selectedIndex;
     let sessionCost = document.getElementById("sessionBox").options[selectedSessionIndex].value;
   }
